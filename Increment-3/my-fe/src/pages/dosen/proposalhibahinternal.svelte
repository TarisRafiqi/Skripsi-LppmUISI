...
{#if pendaftaranHibahInternal === 1}
   <Article>
      <h2 class="title is-2">Proposal PPM Hibah Internal UISI</h2>
      <hr />
...
{:else if pendaftaranHibahInternal === 0}
   <ArticleError>
      <p class="title is-3">Pendaftaran Sedang Ditutup</p>
      <p class="subtitle is-6">
         Pendaftaran Proposal Hibah Internal UISI sedang ditutup tunggu periode
