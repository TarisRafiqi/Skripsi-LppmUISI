...
<Article>
   ...
   {#if tab2 === true}
      <button on:click={buttonModalMataKuliah} class="button is-info"
         >Tambah</button
      >
      <Modal bind:show={modalMataKuliah}>
         <h2 slot="header">Mata Kuliah</h2>
         ...
         <br />
         <Field>
            <button class="button is-info">Simpan</button>
         </Field>
      </Modal>
      <br />
      <br />
