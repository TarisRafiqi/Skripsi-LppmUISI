<script>
   export let code;
   export let jenisSkema;
</script>

{#if jenisSkema === "Riset Mandiri" || jenisSkema === "Pengabdian Masyarakat Mandiri"}
   {#if code === 0}
      <span class="tag is-warning is-light">Draft Proposal</span>
   {:else if code === 1}
      <span class="tag is-danger is-light">Revisi Proposal</span>
   {:else if code === 2}
